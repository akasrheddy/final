    ...
    <header className="bg-primary shadow-md">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-6 text-white">
          ...
          <Link href="/voting">
            <a className="hover:text-accent transition">Vote</a>
          </Link>
          <Link href="/results">
            <a className="hover:text-accent transition">Results</a>
          </Link>
          <Link href="/blockchain">
            <a className="hover:text-accent transition">Blockchain</a>
          </Link>
        </nav>
